...
cost = pc1,
icon_xy = {1, 1},
name_id = "perk01'perk1n",
desc_id = "perk01'perk1d"},
ps2,{
upgrades = {
...
cost = pc3,
icon_xy = {1, 1},
name_id = "perk01'perk3n",
desc_id = "perk01'perk3d"},
ps4,{
upgrades = {
...
cost = pc5,
icon_xy = {1, 1},
name_id = "perk01'perk5n",
desc_id = "perk01'perk5d"},
ps6,{
upgrades = {
...
cost = pc7,
icon_xy = {1, 1},
name_id = "perk01'perk7n",
desc_id = "perk01'perk7d"},
ps8,{
upgrades = {
...
cost = pc9,
icon_xy = {1, 1},
name_id = "perk01'perk9n",
desc_id = "perk01'perk9d"}})
end
