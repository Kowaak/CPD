...
or string_id == "perk01'name" and "Kowaak"
or string_id == "perk01'desc" and "Agressive yet tanky perk deck with an EXP multiplier included on the last perk."
or string_id == "perk01'perk1n" and "Sadistic"
or string_id == "perk01'perk1d" and "Decreases damage you and your crew take by ##8%## \n\nYour second and each consecutive melee hit within ##1## second of the last one will deal ##10## times its normal damage.\n\n You also heal from dealing damage and from killing enemies using melee weapons."
or string_id == "perk01'perk3n" and "500 pound Gorilla"
or string_id == "perk01'perk3d" and "Increases your health by ##80%##. You also regenerate ##3%## of your health every ##5## seconds.\n\nYour shots can now spread panic.\n\n When you pickup ammo you heal yourself. You also heal your teammates. They get ##50%## of the ammo pickup."
or string_id == "perk01'perk5n" and "Berserk"
or string_id == "perk01'perk5d" and "Increases your dodge chance by ##15%##\n\n The lower your health, the more movement speed you gain. When your health is below ##25%##, you will gain up to ##20%## movement speed."
or string_id == "perk01'perk7n" and "Armorer"
or string_id == "perk01'perk7d" and "Increases armor by a huge amount and speeds up its recovery rate."
or string_id == "perk01'perk9n" and "True Kowaak"
or string_id == "perk01'perk9d" and "When you deal damage you replenish some of your armor. The same happens when you dodge.\n\nMultiplies XP gained times 2.
